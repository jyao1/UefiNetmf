...
//    debug_printf ("Events_WaitForEvents (%d - Ticks - %ld)\r\n", Timeout_Milliseconds, CountsRemaining);
...

    {
        ...
        while(true)
        {
            ...
            {
//                debug_printf ("  RunContinuations\r\n");
                // restore interrupts before running a continuation
//                debug_printf ("Events_WaitForEvents (irq.Release)\r\n");
                irq.Release();
//                debug_printf ("Events_WaitForEvents (irq.Release) Done\r\n");

                // if we stall on time, don't check again until after we sleep
                RunContinuations = HAL_CONTINUATION::Dequeue_And_Execute();

//                debug_printf ("Events_WaitForEvents (irq.Acquire)\r\n");
                irq.Acquire();
//                debug_printf ("Events_WaitForEvents (irq.Acquire) Done\r\n");
            }
            else
            {
//                debug_printf ("  !RunContinuations\r\n");
...
//                debug_printf ("Events_WaitForEvents (HAL_COMPLETION::WaitForInterrupts)\r\n");
