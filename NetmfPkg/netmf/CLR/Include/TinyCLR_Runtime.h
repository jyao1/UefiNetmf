...
#if defined(__GNUC__) // JYAO1 - RISK - BUGBUG
    CT_ASSERT( sizeof(CLR_RT_DataTypeLookup) == 20     )
#else
    CT_ASSERT( sizeof(CLR_RT_DataTypeLookup) == 16     )
#endif

#elif defined(ARM_V3_0) || defined(ARM_V3_1) // arm 3.0 compiler uses 8 bytes for a function pointer
