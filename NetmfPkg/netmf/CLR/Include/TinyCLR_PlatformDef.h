...
#define PLATFORM_EMULATED_FLOATINGPOINT
#define TINYCLR_STOP() CpuDeadLoop()
...
#if defined(PLATFORM_ARM) || defined(PLATFORM_BLACKFIN) || defined(PLATFORM_SH) || defined(PLATFORM_UEFI)
#define PROHIBIT_ALL_CONSTRUCTORS(cls)   \
    private:                             \
        cls();                           \
        cls( cls& );                     \
