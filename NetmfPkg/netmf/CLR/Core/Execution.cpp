...
//    CLR_Debug::Printf( "CLR_RT_ExecutionEngine::Execute\r\n" );
...
//    CLR_Debug::Printf( "WaitForDebugger\r\n" );
...
//    CLR_Debug::Printf( "CLR_RT_HeapBlock_Delegate::CreateInstance\r\n" );
...
//        CLR_Debug::Printf( "stack->m_call.m_target->numArgs - 0x%x\r\n", stack->m_call.m_target->numArgs );
...
#endif
            {
//                CLR_Debug::Printf( "CLR_RT_HeapBlock_Array::CreateInstance\r\n" );
...
//    CLR_Debug::Printf( "SpawnStaticConstructor\r\n" );
    ...
    while(true)
    {
//        CLR_Debug::Printf( "ScheduleThreads\r\n" );
        ...
        {
//            CLR_Debug::Printf( "CLR_EE_DBG_IS RebootPending|ExitPending|ClrOnly\r\n" );
        ...
        {
//            CLR_Debug::Printf( "CLR_EE_DBG_IS Stopped\r\n" );
        ...
        {            
//            CLR_Debug::Printf( "CLR_EE_DBG_IS Compaction_Pending\r\n" );
            PerformHeapCompaction();
        ...
        {
//            CLR_Debug::Printf( "WaitForActivity\r\n" );
            WaitForActivity();
        }
     ...
     */
//    CLR_Debug::Printf( "g_CLR_PRF_Profiler.Stream_Flush\r\n" );
    g_CLR_PRF_Profiler.Stream_Flush();
#endif

//    CLR_Debug::Printf( "g_CLR_RT_Persistence_Manager.Flush\r\n" );
    g_CLR_RT_Persistence_Manager.Flush();
...
{
//    CLR_Debug::Printf( "  CLR_RT_ExecutionEngine::StaticConstructorTerminationCallback\r\n" );
    NATIVE_PROFILE_CLR_CORE();
...
//    CLR_Debug::Printf( "  CLR_RT_ExecutionEngine::SpawnStaticConstructorHelper\r\n" );
//    CLR_Debug::Printf( "    appDomain - 0x%x\r\n", appDomain );
//    CLR_Debug::Printf( "    appDomainAssembly - 0x%x\r\n", appDomainAssembly );
...
//      CLR_Debug::Printf( "  appDomainAssembly->m_assembly\r\n", appDomainAssembly->m_assembly );
//    }
//    CLR_Debug::Printf( "  appDomainAssembly->m_assembly->FindNextStaticConstructor\r\n" );
...
//    CLR_Debug::Printf( "  CLR_RT_ExecutionEngine::SpawnStaticConstructor\r\n" );
...
//        CLR_Debug::Printf( "  SpawnStaticConstructorHelper - 0x%x\r\n", idx.m_data );
...
//    CLR_Debug::Printf( "  CLR_RT_ExecutionEngine::ScheduleThreads\r\n" );
#if defined(TINYCLR_APPDOMAINS)                    
...
//        CLR_Debug::Printf( "  PutInProperList\r\n" );
        PutInProperList( th );
...
CLR_UINT32 CLR_RT_ExecutionEngine::WaitForActivity()
{
    ...
    CLR_Debug::Printf( "CLR_RT_ExecutionEngine::WaitForActivity()\r\n" );
...
CLR_UINT32 CLR_RT_ExecutionEngine::WaitForActivity( CLR_UINT32 powerLevel, CLR_UINT32 events, CLR_INT64 timeout_ms )
{
    ...
    CLR_Debug::Printf( "CLR_RT_ExecutionEngine::WaitForActivity - %ld\r\n", timeout_ms );
...
{
//    CLR_Debug::Printf( "  CLR_RT_ExecutionEngine::PutInProperList\r\n" );
    NATIVE_PROFILE_CLR_CORE();
    switch(th->m_status)
    {
...
HRESULT CLR_RT_ExecutionEngine::Sleep( CLR_RT_Thread* caller, const CLR_INT64& timeExpire )
{
    ...
    CLR_Debug::Printf( "ExecutionEngine::Sleep\r\n" );
...
//    CLR_Debug::Printf( "ExecutionEngine::InitTimeout\r\n" );
...
CLR_UINT32 CLR_RT_ExecutionEngine::WaitSystemEvents( CLR_UINT32 powerLevel, CLR_UINT32 events, CLR_INT64 timeExpire )
{
    ...
    CLR_Debug::Printf( "CLR_RT_ExecutionEngine::WaitSystemEvents - %ld\r\n", timeExpire );
