...
//    CLR_Debug::Printf( "  CLR_RT_Assembly::CreateInstance\r\n" );
...
//            CLR_Debug::Printf( "  (asm 0x%x)", assm);
...
//    CLR_Debug::Printf( "  CLR_RT_Assembly::Resolve_AssemblyRef\r\n" );
...
HRESULT CLR_RT_AppDomain::LoadAssembly( CLR_RT_Assembly* assm )
{
    ...
    FAULT_ON_NULL( assm );
//    CLR_Debug::Printf( "  CLR_RT_AppDomain::LoadAssembly - 0x%x\r\n", assm );
...
{
//    CLR_Debug::Printf( "  CLR_RT_AppDomain::FindAppDomainAssembly - 0x%x\r\n", assm );
    NATIVE_PROFILE_CLR_CORE();
    if(m_appDomainAssemblyLastAccess != NULL && m_appDomainAssemblyLastAccess->m_assembly == assm)
    {
//        CLR_Debug::Printf( "    m_appDomainAssemblyLastAccess - 0x%x\r\n", m_appDomainAssemblyLastAccess );
        return m_appDomainAssemblyLastAccess;
    }

    TINYCLR_FOREACH_NODE(CLR_RT_AppDomainAssembly,appDomainAssembly,m_appDomainAssemblies)
    {
//        CLR_Debug::Printf( "    try - 0x%x\r\n", appDomainAssembly->m_assembly );
...
//    CLR_Debug::Printf( "  CLR_RT_AppDomainAssembly::CreateInstance\r\n" );
...
//    CLR_Debug::Printf( "  CLR_RT_AppDomainAssembly::AppDomainAssembly_Initialize\r\n" );
//    CLR_Debug::Printf( "    appDomain - 0x%x\r\n", appDomain );
//    CLR_Debug::Printf( "    assm - 0x%x\r\n", assm );
...
HRESULT CLR_RT_Assembly::PrepareForExecution()
{
    NATIVE_PROFILE_CLR_CORE();
    TINYCLR_HEADER();
//    CLR_Debug::Printf( "  CLR_RT_Assembly::PrepareForExecution\r\n" );
...
//        CLR_Debug::Printf( "    g_CLR_RT_ExecutionEngine.GetCurrentAppDomain()->LoadAssembly\r\n" );
...
//    CLR_Debug::Printf( "CLR_RT_TypeSystem::ResolveAll\r\n" );
    bool fOutput = false;
...
//    CLR_Debug::Printf( "CLR_RT_TypeSystem::PrepareForExecution\r\n" );
#if defined(TINYCLR_ENABLE_SOURCELEVELDEBUGGING)
    ...
    TINYCLR_FOREACH_ASSEMBLY(*this)
    {
//        CLR_Debug::Printf( "pASSM->PrepareForExecution - 0x%x\r\n", pASSM );
        TINYCLR_CHECK_HRESULT(pASSM->PrepareForExecution());
    }
    TINYCLR_FOREACH_ASSEMBLY_END();
